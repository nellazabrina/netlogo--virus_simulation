turtles-own
  [ sick?                ;; if true, the turtle is infectious
    ...
    sick-xcor            ;; x coordinate when turtle become sick
    sick-ycor ]          ;; y coordinate when turtle become sick
...
to move ;; turtle procedure
  ...
  fd 1
  if sick? [
    if xcor > sick-xcor + max-radius or xcor < sick-xcor - max-radius or ycor > sick-ycor + max-radius or ycor < sick-ycor - max-radius [
      bk 1
    ]
  ]
end
